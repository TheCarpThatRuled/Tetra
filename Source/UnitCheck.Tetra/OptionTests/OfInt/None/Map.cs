...
public class None_Map
{
   ...
   [TestMethod]
   public void GIVEN_None_of_int_WHEN_Map_AND_whenSome_is_a_Func_of_int_to_int_THEN_whenSome_was_not_invoked_AND_a_none_is_returned()
   {
   ...
   [TestMethod]
   public void GIVEN_None_of_int_WHEN_Map_AND_whenSome_is_a_Func_of_int_to_TestClass_THEN_whenSome_was_not_invoked_AND_a_none_is_returned()
   {
   ...
   [TestMethod]
   public void GIVEN_None_of_int_WHEN_Map_AND_whenSome_is_a_Func_of_int_to_TestStruct_THEN_whenSome_was_not_invoked_AND_a_none_is_returned()
   {
   ...
   [TestMethod]
   public void GIVEN_None_of_int_WHEN_Map_AND_whenSome_is_a_Func_of_int_to_uint_THEN_whenSome_was_not_invoked_AND_a_none_is_returned()
   {
