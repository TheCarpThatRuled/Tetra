...
public class None_Reduce
{
   ...
   [TestMethod]
   public void
      GIVEN_None_of_TestClass_WHEN_Reduce_AND_whenNone_is_an_int_AND_whenSome_is_a_Func_of_TestClass_to_int_THEN_whenSome_was_not_invoked_AND_the_return_value_of_whenNone_is_returned()
   {
   ...
   [TestMethod]
   public void
      GIVEN_None_of_TestClass_WHEN_Reduce_AND_whenNone_is_a_TestClass_AND_whenSome_is_a_Func_of_TestClass_to_TestClass_THEN_whenSome_was_not_invoked_AND_the_return_value_of_whenNone_is_returned()
   {
   ...
   [TestMethod]
   public void
      GIVEN_None_of_TestClass_WHEN_Reduce_AND_whenNone_is_a_TestStruct_AND_whenSome_is_a_Func_of_TestClass_to_TestStruct_THEN_whenSome_was_not_invoked_AND_the_return_value_of_whenNone_is_returned()
   {
