...
public class Some_Reduce
{
   ...
   //Some_of_TestStruct
   //WHEN
   //Reduce AND whenNone_is_a_Func_of_TestStruct AND whenSome_is_a_Func_of_TestStruct_to_int
   //THEN
   //whenNone_was_not_invoked AND whenSome_was_invoked_once_with_the_content AND the_return_value_of_whenSome_is_returned

   [TestMethod]
   public void
      GIVEN_Some_of_TestStruct_WHEN_Reduce_AND_whenNone_is_a_Func_of_TestStruct_AND_whenSome_is_a_Func_of_TestStruct_to_int_THEN_whenNone_was_not_invoked_AND_whenSome_was_invoked_once_with_the_content_AND_the_return_value_of_whenSome_is_returned()
   {
      ...
      Arb.Register<Library_TestStruct_AND_TwoUniqueInt32s>();
   ...
   // ReSharper disable once InconsistentNaming
   private sealed class Library_TestStruct_AND_TwoUniqueInt32s
   {
      /* ------------------------------------------------------------ */
      // Methods
      /* ------------------------------------------------------------ */

      public static Arbitrary<TestStruct> TestStruct()
         => Generators
           .TestStruct()
           .ToArbitrary();
   ...
   //Some_of_TestStruct
   //WHEN
   //Reduce AND whenNone_is_a_Func_of_TestClass AND whenSome_is_a_Func_of_TestStruct_to_TestClass
   //THEN
   //whenNone_was_not_invoked AND whenSome_was_invoked_once_with_the_content AND the_return_value_of_whenSome_is_returned
      ...
      GIVEN_Some_of_TestStruct_WHEN_Reduce_AND_whenNone_is_a_Func_of_TestClass_AND_whenSome_is_a_Func_of_TestStruct_to_TestClass_THEN_whenNone_was_not_invoked_AND_whenSome_was_invoked_once_with_the_content_AND_the_return_value_of_whenSome_is_returned()
   {
      ...
      Arb.Register<Library_TestStruct_AND_TwoUniqueTestClasses>();
   ...
   // ReSharper disable once ClassNeverInstantiated.Local
   // ReSharper disable once InconsistentNaming
   private sealed class Library_TestStruct_AND_TwoUniqueTestClasses
   {
      /* ------------------------------------------------------------ */
      // Methods
      /* ------------------------------------------------------------ */
      ...
      public static Arbitrary<(TestClass, TestClass)> TwoUniqueTestClasses()
         => Generators
   ...
   //Some_of_TestStruct
   //WHEN
   //Reduce AND whenNone_is_a_Func_of_TestStruct AND whenSome_is_a_Func_of_TestStruct_to_TestStruct
   //THEN
   //whenNone_was_not_invoked AND whenSome_was_invoked_once_with_the_content AND the_return_value_of_whenSome_is_returned
