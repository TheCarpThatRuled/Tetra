...
public class Missing_Reduce
{
   ...
   [TestMethod]
   public void
      GIVEN_Missing_of_TestStruct_WHEN_Reduce_AND_whenFuncs_are_a_Func_of_T_to_int_THEN_whenMissing_was_invoked_once_with_the_content_AND_whenMissing_was_not_invoked_AND_whenOpen_was_not_invoked_AND_the_return_value_of_whenMissing_is_returned()
   {
   ...
   [TestMethod]
   public void
      GIVEN_Missing_of_TestStruct_WHEN_Reduce_AND_whenFuncs_are_a_Func_of_T_to_TestClass_THEN_whenMissing_was_invoked_once_with_the_content_AND_whenLocked_was_not_invoked_AND_whenOpen_was_not_invoked_AND_the_return_value_of_whenMissing_is_returned()
   {
      static Property Property(AbsoluteFilePath                                                  path,
                               Message                                                           message,
   ...
   [TestMethod]
   public void
      GIVEN_Missing_of_TestStruct_WHEN_Reduce_AND_whenFuncs_are_a_Func_of_T_to_TestStruct_THEN_whenMissing_was_invoked_once_with_the_content_AND_whenLocked_was_not_invoked_AND_whenOpen_was_not_invoked_AND_the_return_value_of_whenMissing_is_returned()
   {
      static Property Property(AbsoluteFilePath                                                     path,
                               Message                                                              message,
