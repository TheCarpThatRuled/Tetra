...
public class Failure_Map
{
   ...
   [TestMethod]
   public void
      GIVEN_Failure_of_TestClass_WHEN_Map_AND_whenFailure_is_a_Func_of_Failure_to_Message_THEN_whenFailure_was_invoked_once_with_the_content_AND_a_failure_containing_the_return_value_of_whenFailure_is_returned()
   {
   ...
   //Failure_of_TestClass
   //WHEN
   //Map_AND_whenSuccess_is_a_Func_of_Success_of_TestClass_to_int
   //THEN
   //whenSuccess_was_not_invoked_AND_a_Failure_containing_the_content_is_returned

   [TestMethod]
   public void
      GIVEN_Failure_of_TestClass_WHEN_Reduce_AND_Map_AND_whenSuccess_is_a_Func_of_Success_of_TestClass_to_int_THEN_whenSuccess_was_not_invoked_AND_a_Failure_containing_the_content_is_returned()
   {
   ...
   [TestMethod]
   public void
      GIVEN_Failure_of_TestClass_WHEN_Reduce_AND_Map_AND_whenSuccess_is_a_Func_of_Success_of_TestClass_to_TestClass_THEN_whenSuccess_was_not_invoked_AND_a_Failure_containing_the_content_is_returned()
   {
      static Property Property(Message   content,
   ...
   [TestMethod]
   public void
      GIVEN_Failure_of_TestClass_WHEN_Reduce_AND_Map_AND_whenSuccess_is_a_Func_of_Success_of_TestClass_to_TestStruct_THEN_whenSuccess_was_not_invoked_AND_a_Failure_containing_the_content_is_returned()
   {
      static Property Property(Message    content,
