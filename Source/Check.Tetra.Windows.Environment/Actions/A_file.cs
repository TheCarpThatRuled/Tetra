...
public static class A_file
{
   ...
   public static AAA_test.IArrange<Arranges, Arranges> Is_locked
   (
      string path
   )
      => AAA_test.AtomicArrange<Arranges, Arranges>
   ...
   public static AAA_test.IArrange<Arranges, Arranges> Exists_and_is_locked
   (
      string path
   )
      => Exists(path)
   ...
   public static AAA_test.IArrange<Arranges, Arranges> Is_unlocked
   (
      string path
   )
      => AAA_test.AtomicArrange<Arranges, Arranges>
