...
public static class The_client
{
   ...
   public static AAA_test.IAct<Arranges, ObjectAsserts<bool, Asserts>> Checks_that_a_directory_does_not_exist
   (
      AbsoluteDirectoryPath path
   )
      => AAA_test.AtomicAct<Arranges, ObjectAsserts<bool, Asserts>>
   ...
   public static AAA_test.IAct<Arranges, ObjectAsserts<bool, Asserts>> Checks_that_a_directory_exists
   (
      AbsoluteDirectoryPath path
   )
      => AAA_test.AtomicAct<Arranges, ObjectAsserts<bool, Asserts>>
   ...
   public static AAA_test.IAct<Arranges, ObjectAsserts<bool, Asserts>> Checks_that_a_file_does_not_exist
   (
   ...
   public static AAA_test.IAct<Arranges, ObjectAsserts<bool, Asserts>> Checks_that_a_file_exists
   (
      AbsoluteFilePath path
   )
      => AAA_test.AtomicAct<Arranges, ObjectAsserts<bool, Asserts>>
   ...
   public static AAA_test.IAct<Arranges, OptionAsserts<Message, Asserts>> Creates_a_directory
   (
      AbsoluteDirectoryPath path
   )
      => AAA_test.AtomicAct<Arranges, OptionAsserts<Message, Asserts>>
   ...
   public static AAA_test.IAct<Arranges, ObjectAsserts<AbsoluteDirectoryPath, Asserts>> Gets_the_current_directory()
      => AAA_test.AtomicAct<Arranges, ObjectAsserts<AbsoluteDirectoryPath, Asserts>>
   ...
   public static AAA_test.IAct<Arranges, OptionAsserts<Message, Asserts>> Sets_the_current_directory
   (
      AbsoluteDirectoryPath path
   )
      => AAA_test.AtomicAct<Arranges, OptionAsserts<Message, Asserts>>
