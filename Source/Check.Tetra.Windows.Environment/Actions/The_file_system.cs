...
public static class The_file_system
{
   ...
   public static AAA_test.IArrange<Arranges, Arranges> Creates_a_sandbox
   (
      string directory
   )
   ...
   public static AAA_test.IAssert<Asserts, Asserts> Contains_a_directory
   (
      string expected
   )
      => AAA_test.AtomicAssert<Asserts, Asserts>
   ...
   public static AAA_test.IAssert<Asserts, Asserts> Contains_a_file
   (
      string expected
   )
      => AAA_test.AtomicAssert<Asserts, Asserts>
   ...
   public static AAA_test.IAssert<Asserts, Asserts> Does_not_contains_a_directory
   (
      string expected
   )
      => AAA_test.AtomicAssert<Asserts, Asserts>
   ...
   public static AAA_test.IAssert<Asserts, Asserts> Does_not_contains_a_file
   (
      string expected
   )
      => AAA_test.AtomicAssert<Asserts, Asserts>
   ...
   public static AAA_test.IAssert<Asserts, Asserts> Has_a_current_directory_of
   (
      string expected
   )
      => AAA_test.AtomicAssert<Asserts, Asserts>
