...
partial class Steps
{
   partial class TheWhenLeft
   {
      ...
      public sealed class ForUnify
      {
         ...
         public IAssert<TheEitherHasBeenCreated.AndUnifyWasCalledAsserts, TheEitherHasBeenCreated.AndUnifyWasCalledAsserts> was_invoked_once_with(FakeLeft expected)
