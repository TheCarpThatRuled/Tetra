...
partial class Steps
{
   public sealed class TheReturnValue
   {
      ...
      public IAssert is_equal_to<T>(T expected)
         => AtomicAssert
      ...
      // ReSharper disable once InconsistentNaming
      public IAssert is_a_left_containing<TLeft, TRight>(TLeft expected)
         => AtomicAssert
      ...
      // ReSharper disable once InconsistentNaming
      public IAssert is_a_right_containing<TLeft, TRight>(TRight expected)
         => AtomicAssert
      ...
      // ReSharper disable once InconsistentNaming
      public IAssert is_a_some_containing<T>(T expected)
         => AtomicAssert
