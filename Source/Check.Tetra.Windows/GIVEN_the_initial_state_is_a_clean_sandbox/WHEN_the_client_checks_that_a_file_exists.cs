...
[TestClass]
public class WHEN_the_client_checks_that_a_file_exists : AAATestDataSource
{
   /* ------------------------------------------------------------ */
   // Test
   /* ------------------------------------------------------------ */
   ...
   [TestMethod]
   [WHEN_the_client_checks_that_a_file_exists]
   public void Run
   (
      AAA_test test
   )
   ...
   protected override IEnumerable<AAA_test> GetTests()
   {
      ...
      yield return AAA_test
                  ...
                  .WHEN(the_client.Checks_that_a_file_exists(file))
