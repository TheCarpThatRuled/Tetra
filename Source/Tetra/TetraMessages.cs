...
public static class TetraMessages
{
   ...
   public static string IsNotValidBecauseAnAbsoluteFilePathMayNotEndWithADirectorySeparator
   (
      string path,
      string pathType
   )
   ...
   public static string IsNotValidBecauseAnAbsolutePathMayNotBeEmpty
   (
      string path,
      string pathType
   )
   ...
   public static string IsNotValidBecauseAnAbsolutePathMayNotContainTheCharacters
   (
      string path,
      string pathType
   )
   ...
   public static string IsNotValidBecauseAnAbsolutePathMustStartWithAVolumeLabel
   (
      string path,
      string pathType
   )
   ...
   public static string IsNotValidBecauseAComponentMayNotContainTheCharacters
   (
      string component,
   ...
   public static string IsNotValidBecauseARelativeFilePathMayNotEndWithADirectorySeparator
   (
      string path,
      string pathType
   )
   ...
   public static string IsNotValidBecauseARelativePathMayNotBeEmpty
   (
      string path,
      string pathType
   )
   ...
   public static string IsNotValidBecauseARelativePathMayNotContainTheCharacters
   (
      string path,
      string pathType
   )
   ...
   public static string IsNotValidBecauseAVolumeLabelMustBeAnASCIILetter
   (
      char   volume,
      string volumeType
   )
