...
/// <list type="bullet">
/// <item>
/// <description><b>Left</b>, representing a state mutually exclusive with <b>right</b> and containing an instance of <c>TLeft</c>;</description>
/// </item>
/// <item>
/// <description><b>Right</b>, representing a state mutually exclusive with <b>left</b> and containing an instance of <c>TRight</c>;</description>
/// </item>
/// </list>
/// </summary>
...
public interface IEither<out TLeft, out TRight>
{
   ...
   /// <summary>
   /// Invokes an action on the contents of the <c>IEither</c> if it as <b>left</b>, else invokes a different action on the <c>IEither</c>  is a <b>right</b>.
   /// </summary>
   /// <param name="whenLeft">The action that shall be invoked with the content of the <c>IEither</c>, if it is a <b>left</b>.</param>
   /// <param name="whenRight">The action that shall be invoked with the content of the <c>IEither</c>, if it is a <b>right</b>.</param>
   /// <returns>
   /// The result.
   /// </returns>
