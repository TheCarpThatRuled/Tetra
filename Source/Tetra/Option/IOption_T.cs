...
public interface IOption<out T>
{
   ...
   /// <summary>
   ///    Invokes an action on the contents of the <c>IOption</c> if it as <b>some</b>, else invokes an different action on
   ///    the <c>IOption</c>  is a <b>none</b>.
   /// </summary>
   ...
   /// <param name="whenNone">
   ///    The function that will create the value that should be used, if the <c>IOption</c> is a
   ///    <b>none</b>.
   /// </param>
   /// <returns>
   ...
   /// <param name="whenSome">
   ///    The mapping function that shall be applied to the content of the <c>IOption</c>, if it is a
   ///    <b>some</b>.
   /// </param>
   /// <returns>
