...
public sealed class Characterisation
{
   ...
   (
      Func<IndentingStringBuilder, IndentingStringBuilder> appendBrief,
   ...
   public static implicit operator Characterisation
   (
   ...
   public static Characterisation Create
   (
      string characterisation
   )
   ...
   public IndentingStringBuilder AppendBrief
   (
   ...
   public IndentingStringBuilder AppendFull
   (
      IndentingStringBuilder builder
   )
      => _appendFull(builder);
