                                     ...
                                     IEquatable<RelativeDirectoryPath>
{
   ...
   public static RelativeDirectoryPath Create
   (
   ...
   public static IEither<RelativeDirectoryPath, Message> Parse
   (
      string potentialPath
   )
      => ParseComponents(potentialPath,
   ...
   public RelativeDirectoryPath Append
   (
   ...
   public RelativeFilePath Append
   (
      FileComponent child
   )
      => RelativeFilePath
   ...
   public AbsoluteDirectoryPath Prepend
   (
   ...
   public RelativeDirectoryPath Prepend
   (
   ...
   protected static IEither<ISequence<DirectoryComponent>, Message> ParseComponents
   (
      string potentialPath,
      string pathType
   )
   ...
   private static RelativeDirectoryPath CreateInternal
   (
      ISequence<DirectoryComponent> success
   )
      => new(success);
