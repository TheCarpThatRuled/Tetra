...
public static class VolumeComponent_Extensions
{
   ...
   public static AbsoluteDirectoryPath Append
   (
      this   VolumeComponent      parent,
   ...
   public static AbsoluteFilePath Append
   (
      this VolumeComponent parent,
      FileComponent        child
   )
   ...
   public static AbsoluteDirectoryPath ToPath
   (
      this VolumeComponent volume
   )
      => AbsoluteDirectoryPath
        .Create(volume,
                Sequence<DirectoryComponent>.Empty());
