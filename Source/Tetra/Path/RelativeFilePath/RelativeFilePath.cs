                                ...
                                IEquatable<RelativeFilePath>
{
   ...
   public static RelativeFilePath Create
   (
   ...
   public static IEither<RelativeFilePath, Message> Parse
   (
      string potentialPath
   )
      => ParseComponents(potentialPath,
   ...
   public AbsoluteFilePath Prepend
   (
   ...
   public RelativeFilePath Prepend
   (
   ...
   protected static IEither<(ISequence<DirectoryComponent> directories, FileComponent file), Message> ParseComponents
   (
      string potentialPath,
      string pathType
   )
   ...
   private static RelativeFilePath Create
   (
      (ISequence<DirectoryComponent> directories, FileComponent file) success
   )
