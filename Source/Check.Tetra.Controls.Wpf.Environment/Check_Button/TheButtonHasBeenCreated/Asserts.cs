...
public sealed partial class TheButtonHasBeenCreated
{
      ...
      where TThen : IAssertsInstance
   {
      ...
      public Asserts<TThen> The_Click_callback_was_invoked()
      {
         Add(characterisation => characterisation.AddClauseToCharacterisation(nameof(The_Click_callback_was_invoked)),
             then => then.The_Click_callback_was_invoked());
