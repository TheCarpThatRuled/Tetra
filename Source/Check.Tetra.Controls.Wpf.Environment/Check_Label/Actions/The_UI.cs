...
public static class The_UI
{
   ...
   public static AAA_test.IArrange<TheLabelHasNotBeenCreated.Arranges> Has_not_created_the_label()
      => AAA_test.AtomicArrange<TheLabelHasNotBeenCreated.Arranges>
                 .Create($"{nameof(The_UI)}.{nameof(Has_not_created_the_label)}",
                         TheLabelHasNotBeenCreated.Arranges.Create);

   /* ------------------------------------------------------------ */

   public static AAA_test.IArrange<TheLabelHasBeenCreated.Arranges> Has_created_the_label
   (
   ...
   (
      ...
      => AAA_test.AtomicArrangeAct<TheLabelHasNotBeenCreated.Arranges, TheLabelHasBeenCreated.Arranges, TheLabelHasBeenCreated.Asserts>
                 .Create($"{nameof(The_UI)}.{nameof(Creates_the_label)}: {args.BriefCharacterisation()}",
                         environment => environment.The_UI_creates_the_label(args),
