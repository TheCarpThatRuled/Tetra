...
public static class The_UI
{
   ...
   public static AAA_test.IArrange<TheTextBoxHasNotBeenCreated.Arranges> Has_not_created_the_text_box()
      => AAA_test.AtomicArrange<TheTextBoxHasNotBeenCreated.Arranges>
                 .Create($"{nameof(The_UI)}.{nameof(Has_not_created_the_text_box)}",
                         TheTextBoxHasNotBeenCreated.Arranges.Create);

   /* ------------------------------------------------------------ */

   public static AAA_test.IArrange<TheTextBoxHasBeenCreated.Arranges> Has_created_the_text_box
   (
   ...
   (
      ...
      => AAA_test.AtomicArrangeAct<TheTextBoxHasNotBeenCreated.Arranges, TheTextBoxHasBeenCreated.Arranges, TheTextBoxHasBeenCreated.Asserts>
