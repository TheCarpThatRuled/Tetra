...
public static class Gen_Extensions
{
   ...
   public static Gen<T3> Combine<T0, T1, T2, T3>(this Gen<T0>         source0,
                                                 Gen<T1>              source1,
                                                 Gen<T2>              source2,
   ...
   public static Gen<T4> Combine<T0, T1, T2, T3, T4>(this Gen<T0>             source0,
                                                     Gen<T1>                  source1,
                                                     Gen<T2>                  source2,
                                                     Gen<T3>                  source3,
   ...
   public static Gen<(T0 first, T1 second)> ZipValueTuples<T0, T1>(this Gen<T0> first,
                                                                   Gen<T1>      second)
      => first
        .Zip(second)
        .Select(x => (x.Item1, x.Item2));
   ...
   public static Gen<(T0 first, T1 second, T2 third)> ZipValueTuples<T0, T1, T2>(this Gen<T0> first,
                                                                                 Gen<T1>      second,
                                                                                 Gen<T2>      third)
      => first
        .Zip(second,
