...
public static partial class Generators
{
   ...
   public static Gen<List<T>> ListOf<T>
   (
      Gen<T> source
   )
      => Gen
   ...
   public static Gen<T[]> NonEmptyArrayOf<T>
   (
      Gen<T> source
   )
      => Gen
   ...
   public static Gen<List<T>> NonEmptyListOf<T>
   (
      Gen<T> source
   )
      => Gen
   ...
   public static Gen<ISequence<T>> NonEmptySequenceOf<T>
   (
      Gen<T> source
   )
      => Gen
   ...
   public static Gen<ISequence<T>> SequenceOf<T>
   (
      Gen<T> source
   )
      => Gen
   ...
   public static Gen<(T, T, T)> Transitive<T>
   (
      Gen<(T, T)> source
   )
      where T : notnull
   ...
   public static Gen<(T0, T1, T1)> Transitive<T0, T1>
   (
      Gen<(T1, T1)> source,
      Func<T1, T0>  map
   )
