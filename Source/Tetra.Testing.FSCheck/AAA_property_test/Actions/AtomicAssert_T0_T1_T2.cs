...
partial class AAA_property_test<TState>
{
      ...
      where TNextAsserts : IAsserts
   {
      ...
      public static AtomicAssert<TInitialAsserts, TNextAsserts> Create(Func<TState, TInitialAsserts, TNextAsserts> arrange,
      ...
      private AtomicAssert(Func<TState, TInitialAsserts, TNextAsserts> assert,
                           string                                      characterisation)
      {
         _assert           = assert;
