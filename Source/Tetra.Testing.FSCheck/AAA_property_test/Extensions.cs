...
public static class AAA_property_test_Extensions
{
   ...
   public static AAA_property_test<TState>.IAct<TArranges, TAsserts> Recharacterise<TState, TArranges, TAsserts>
   (
      this AAA_property_test<TState>.IAct<TArranges, TAsserts> act,
      string                                                   characterisation
   )
      where TArranges : IArranges
      where TAsserts : AAA_property_test<TState>.IAsserts
      => AAA_property_test<TState>.RecharacterisedAct<TArranges, TAsserts>
                                  .Create(act,
                                          characterisation);

   /* ------------------------------------------------------------ */

   public static AAA_property_test<TState>.IAct<TArranges, TAsserts> Silence<TState, TArranges, TAsserts>
   (
      this AAA_property_test<TState>.IAct<TArranges, TAsserts> act
   )
      where TArranges : IArranges
      where TAsserts : AAA_property_test<TState>.IAsserts
      => AAA_property_test<TState>.SilentAct<TArranges, TAsserts>
                                  .Create(act);
   ...
   public static AAA_property_test<TState>.IArrange<TNextArranges> And<TState, TInitialArranges, TNextArranges>
   (
      this AAA_property_test<TState>.IArrange<TInitialArranges> first,
      ...
      => AAA_property_test<TState>.CompoundArrange<TInitialArranges, TNextArranges>
                                  .Create(first,
                                          second);

   /* ------------------------------------------------------------ */

   public static AAA_property_test<TState>.IArrange<TArranges> Recharacterise<TState, TArranges>
   (
      this AAA_property_test<TState>.IArrange<TArranges> arrange,
      string                                             characterisation
   )
      where TArranges : IArranges
      => AAA_property_test<TState>.RecharacterisedArrange<TArranges>
                                  .Create(arrange,
                                          characterisation);

   /* ------------------------------------------------------------ */

   public static AAA_property_test<TState>.IArrange<TArranges> Silence<TState, TArranges>
   (
      this AAA_property_test<TState>.IArrange<TArranges> arrange
   )
      where TArranges : IArranges
      => AAA_property_test<TState>.SilentArrange<TArranges>
                                  .Create(arrange);
   ...
   (
      ...
      where TNextArranges : IArranges
      => AAA_property_test<TState>.CompoundArrange<TInitialArranges, TMiddleArranges, TNextArranges>
                                  .Create(first,
                                          second);
   ...
   (
      ...
      where TInitialArranges : IArranges
      where TNextArranges : IArranges
      => AAA_property_test<TState>.RecharacterisedArrange<TInitialArranges, TNextArranges>
                                  .Create(arrange,
                                          characterisation);
   ...
   (
      ...
      where TInitialArranges : IArranges
      where TNextArranges : IArranges
      => AAA_property_test<TState>.SilentArrange<TInitialArranges, TNextArranges>
                                  .Create(arrange);
   ...
   (
      ...
      => AAA_property_test<TState>.RecharacterisedArrangeAct<TInitialArranges, TNextArranges, TNextAsserts>
                                  .Create(arrange,
                                          characterisation);
   ...
   (
      ...
      where TNextArranges : IArranges
      where TNextAsserts : AAA_property_test<TState>.IAsserts
      => AAA_property_test<TState>.SilentArrangeAct<TInitialArranges, TNextArranges, TNextAsserts>
                                  .Create(arrange);
   ...
   (
      ...
      where TNextAsserts : AAA_property_test<TState>.IAsserts
      => AAA_property_test<TState>.CompoundAssert<TInitialAsserts, TMiddleAsserts, TNextAsserts>
                                  .Create(first,
                                          second);
   ...
   (
      ...
      where TInitialAsserts : AAA_property_test<TState>.IAsserts
      where TNextAsserts : AAA_property_test<TState>.IAsserts
      => AAA_property_test<TState>.RecharacterisedAssert<TInitialAsserts, TNextAsserts>
                                  .Create(assert,
                                          characterisation);
   ...
   (
      ...
      => AAA_property_test<TState>.RoutingAssert<TInitialAsserts, TInnerAsserts>
                                  .Create(assert,
                                          map);
   ...
   (
      ...
      where TInitialAsserts : AAA_property_test<TState>.IAsserts
      where TNextAsserts : AAA_property_test<TState>.IAsserts
      => AAA_property_test<TState>.SilentAssert<TInitialAsserts, TNextAsserts>
                                  .Create(assert);
