...
partial class Properties
{
   ...
   public static Property IsARightAnd<TLeft, TRight>(string                         description,
      ...
      => actual
        .IsARight(description,
                  (rightMessage,
                   right) => property($"{rightMessage}",
                                      right.Content),
                  (leftMessage,
                   left) => False(leftMessage),
                  False);
   ...
   public static Property IsALeftAnd<TLeft, TRight>(string                        description,
                                                    Func<string, TLeft, Property> property,
                                                    IEither<TLeft, TRight>        actual)
      => actual
        .IsALeft(description,
                 (leftMessage,
                  left) => property($"{leftMessage}",
                                    left.Content),
                 (rightMessage,
                  right) => False(rightMessage),
                 False);
