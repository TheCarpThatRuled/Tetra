...
partial class Properties
{
   ...
   public static Property EqualsIsReflexive<T>
   (
      T original,
      T copy
   )
   ...
   public static Property EqualsIsReflexive<T0, T1>
   (
      T0 original,
      T0 copy,
      T1 otherType
      ...
      => AsProperty(() => original.Equals(original))
        ...
        .And(AsProperty(() => original.Equals(copy))
               .Label("object.Equals is not reflexive: Comparing against an identical instance is not equal"))
        .And(AsProperty(() => original.Equals(otherType))
               .Label("object.Equals is not pseudo-reflexive: Comparing against an identical instance of a different type is not equal"));

   /* ------------------------------------------------------------ */

   public static Property EqualsIsSymmetric<T>
   (
      T first,
      T second
   )
   ...
   public static Property EqualsIsTransitive<T>
   (
      (T a, T b, T c) values
   )
      where T : notnull
   ...
   public static Property EqualsIsTransitive<T0, T1>
   (
      (T0 a, T1 b, T1 c) values
   )
      where T0 : notnull
      where T1 : notnull
   {
   ...
   public static Property IEquatableIsReflexive<T>
   (
      T original,
      T copy
   )
   ...
   // ReSharper disable once InconsistentNaming
   public static Property IEquatableIsSymmetric<T>
   (
      T first,
      T second
   )
   ...
   // ReSharper disable once InconsistentNaming
   public static Property IEquatableIsTransitive<T>
   (
      (T a, T b, T c) values
   )
      where T : notnull, IEquatable<T>
   ...
   // ReSharper disable once InconsistentNaming
   public static Property IEquatableIsTransitive<TBase, TConcrete>
   (
      (TConcrete a, TConcrete b, TConcrete c) values
   )
   ...
   // ReSharper disable once InconsistentNaming
   public static Property IEquatableIsTransitive<T0, T1>
   (
      (T0 a, T1 b, T1 c) values
   )
