...
public static class Extensions
{
   ...
   public static AAA_test.IAct<TArranges, TAsserts> Recharacterise<TArranges, TAsserts>
   (
      this AAA_test.IAct<TArranges, TAsserts> act,
   ...
   public static AAA_test.IAct<TArranges, TAsserts> Silence<TArranges, TAsserts>
   (
      this AAA_test.IAct<TArranges, TAsserts> act
   )
      where TArranges : IArranges
   ...
   public static AAA_test.IArrange<TNextArranges> And<TInitialArranges, TNextArranges>
   (
      this AAA_test.IArrange<TInitialArranges>           first,
   ...
   public static AAA_test.IArrange<TArranges> Recharacterise<TArranges>
   (
      this AAA_test.IArrange<TArranges> arrange,
      string                            characterisation
   )
      where TArranges : IArranges
   ...
   public static AAA_test.IArrange<TArranges> Silence<TArranges>
   (
      this AAA_test.IArrange<TArranges> arrange
   )
      where TArranges : IArranges
   ...
   public static AAA_test.IArrange<TInitialArranges, TNextArranges> Recharacterise<TInitialArranges, TNextArranges>
   (
      this AAA_test.IArrange<TInitialArranges, TNextArranges> arrange,
      string                                                  characterisation
   )
      where TInitialArranges : IArranges
      where TNextArranges : IArranges
   ...
   public static AAA_test.IArrange<TInitialArranges, TNextArranges> Silence<TInitialArranges, TNextArranges>
   (
      this AAA_test.IArrange<TInitialArranges, TNextArranges> arrange
   )
      where TInitialArranges : IArranges
   ...
   public static AAA_test.IAssert<TInitialAsserts, TNextAsserts> And<TInitialAsserts, TMiddleAsserts, TNextAsserts>
   (
      this AAA_test.IAssert<TInitialAsserts, TMiddleAsserts> first,
   ...
   public static AAA_test.IAssert<TInitialAsserts, TNextAsserts> Recharacterise<TInitialAsserts, TNextAsserts>
   (
      this AAA_test.IAssert<TInitialAsserts, TNextAsserts> assert,
      string                                               characterisation
   )
      where TInitialAsserts : IAsserts
      where TNextAsserts : IAsserts
   ...
   public static AAA_test.IAssert<TInitialAsserts, TInitialAsserts> Route<TInitialAsserts, TInnerAsserts>
   (
      this AAA_test.IAssert<TInnerAsserts, TInitialAsserts> assert,
   ...
   public static AAA_test.IAssert<TInitialAsserts, TNextAsserts> Silence<TInitialAsserts, TNextAsserts>
   (
      this AAA_test.IAssert<TInitialAsserts, TNextAsserts> assert
   )
      where TInitialAsserts : IAsserts
