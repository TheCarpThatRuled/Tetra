...
public static partial class AssertMessages
{
   ...
   public static string TheEitherIsARightWhenWeExpectedItToBeALeft<TLeft, TRight>(string description)
   ...
   public static string TheEitherIsALeftWhenWeExpectedItToBeARight<TLeft, TRight>(string description)
      => $"{description}: {TheEither<TLeft, TRight>()} {Is} {ALeft} {WhenWeExpectedItToBe} {ARight}.";

   /* ------------------------------------------------------------ */

   public static string TheEitherIsUnrecognisedWhenWeExpectedItToBeARight<TLeft, TRight>(string description)
      => $"{description}: {TheEither<TLeft, TRight>()} {Is} {Unrecognised} {WhenWeExpectedItToBe} {ARight}.";

   /* ------------------------------------------------------------ */

   public static string TheEitherIsUnrecognisedWhenWeExpectedItToBeALeft<TLeft, TRight>(string description)
   ...
   internal static string ToTestOutput<TLeft, TRight>(this Either<TLeft, TRight>.RightEither right)
      => $@"Right(""{right.Content}"")";

   /* ------------------------------------------------------------ */

   internal static string ToTestOutput<TLeft, TRight>(this Either<TLeft, TRight>.LeftEither left)
      => $@"Left(""{left.Content}"")";
