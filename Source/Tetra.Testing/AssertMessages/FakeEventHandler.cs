...
partial class AssertMessages
{
   ...
   public static string TheFakeEventHandlerWasFiredAnUnexpectedNumberOfTimes
   (
      string description
   )
   ...
   public static string TheFakeEventHandlerWasFiredMoreThanOnce
   (
      string description
   )
   ...
   public static string TheFakeEventHandlerWasFiredWhenWeExpectedItNotToBe
   (
      string description
   )
   ...
   public static string TheFakeEventHandlerWasNotFiredWhenWeExpectedToHaveBeen
   (
      string description
   )
