...
partial class AssertMessages
{
   ...
   public static string TheFakePropertyChangedEventHandlerWasFiredAnUnexpectedNumberOfTimes
   (
      string description
   )
   ...
   public static string TheFakePropertyChangedEventHandlerWasFiredMoreThanOnce
   (
      string description
   )
   ...
   public static string TheFakePropertyChangedEventHandlerWasFiredWhenWeExpectedItNotToBe
   (
      string description
   )
   ...
   public static string TheFakePropertyChangedEventHandlerWasFiredWithAnUnexpectedArgument
   (
      string description
   )
   ...
   public static string TheFakePropertyChangedEventHandlerWasNotFiredWheWeExpectedToHaveBeen
   (
      string description
   )
