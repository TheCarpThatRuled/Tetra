...
partial class Assert_Extensions
{
      ...
      => actual
        .IsASome(description,
                 (someMessage,
                  some) => assert,
                 (noneMessage,
                  none) => throw Failed.Assert(noneMessage),
   ...
   public static Assert IsASome<T>(this Assert assert,
      ...
      => actual
        .IsASome(description,
                 (someMessage,
                  some) => assert.AreEqual(someMessage,
                                           expected,
                                           some.Content),
                 (noneMessage,
                  none) => throw Failed.Assert(noneMessage),
   ...
   public static Assert IsANone<T>(this Assert assert,
      ...
      => actual
        .IsANone(description,
                 none => assert,
                 (someMessage,
                  some) => throw Failed.Assert(someMessage,
                                               some.ToTestOutput()),
                 unrecognisedMessage => throw Failed.Assert(unrecognisedMessage));
   ...
   internal static TReturn IsASome<T, TReturn>(this IOption<T>                             actual,
                                               string                                      description,
   ...
   internal static TReturn IsANone<T, TReturn>(this IOption<T>                             actual,
                                               string                                      description,
   ...
   internal static TReturn Switch<T, TReturn>(this IOption<T>                     actual,
