...
public class Missing_Do
{
   ...
   [TestMethod]
   public void
      GIVEN_Missing_of_int_WHEN_Do_THEN_whenMissing_was_invoked_once_with_the_content_AND_whenLocked_was_not_invoked_AND_whenOpen_was_not_invoked_AND_this_is_returned()
   {
