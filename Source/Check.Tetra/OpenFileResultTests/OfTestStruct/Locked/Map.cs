...
public class Locked_Map
{
   ...
   [TestMethod]
   public void
      GIVEN_Locked_of_TestStruct_WHEN_Map_AND_whenOpen_is_a_Func_of_TestStruct_to_int_THEN_whenOpen_was_not_invoked_AND_a_Locked_containing_the_content_is_returned()
   {
   ...
   [TestMethod]
   public void
      GIVEN_Locked_of_TestStruct_WHEN_Map_AND_whenOpen_is_a_Func_of_TestStruct_to_TestClass_THEN_whenOpen_was_not_invoked_AND_a_Locked_containing_the_content_is_returned()
   {
      static Property Property
      (
         AbsoluteFilePath path,
   ...
   [TestMethod]
   public void
      GIVEN_Locked_of_TestStruct_WHEN_Map_AND_whenOpen_is_a_Func_of_TestStruct_to_TestStruct_THEN_whenOpen_was_not_invoked_AND_a_Locked_containing_the_content_is_returned()
   {
      static Property Property
      (
         AbsoluteFilePath path,
