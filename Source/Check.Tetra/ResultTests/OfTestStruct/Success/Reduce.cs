...
public class Success_Reduce
{
   ...
   [TestMethod]
   public void
      GIVEN_Success_of_TestStruct_WHEN_Reduce_AND_whenSuccess_is_a_Func_of_int_AND_whenFailure_is_a_Func_of_TestStruct_to_int_THEN_whenSuccess_was_invoked_once_AND_whenFailure_was_not_invoked_AND_the_return_value_of_whenSuccess_is_returned()
   {
   ...
   [TestMethod]
   public void
      GIVEN_Success_of_TestStruct_WHEN_Reduce_AND_whenSuccess_is_a_Func_of_TestClass_AND_whenFailure_is_a_Func_of_TestStruct_to_TestClass_THEN_whenSuccess_was_invoked_once_AND_whenFailure_was_not_invoked_AND_the_return_value_of_whenSuccess_is_returned()
   {
   ...
   [TestMethod]
   public void
      GIVEN_Success_of_TestStruct_WHEN_Reduce_AND_whenSuccess_is_a_Func_of_TestStruct_AND_whenFailure_is_a_Func_of_TestStruct_to_TestStruct_THEN_whenSuccess_was_invoked_once_AND_whenFailure_was_not_invoked_AND_the_return_value_of_whenSuccess_is_returned()
   {
