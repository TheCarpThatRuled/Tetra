...
public static class A_label
{
   ...
   public static AAA_test.IAssert<LabelAsserts<T>, T> Matches<T>
   (
   ...
   public static AAA_test.IAssert<LabelAsserts<T>, LabelAsserts<T>> Content_is<T>
   (
      object expected,
      string characterisationHeader
   )
      where T : IAsserts
      => AAA_test.AtomicAssert<LabelAsserts<T>, LabelAsserts<T>>
   ...
   public static AAA_test.IAssert<LabelAsserts<T>, T> ReturnToParent<T>()
      where T : IAsserts
      => AAA_test.SilentAssert<LabelAsserts<T>, T>
                 .Create(asserts => asserts.ReturnToParent());

   /* ------------------------------------------------------------ */

   public static AAA_test.IAssert<LabelAsserts<T>, LabelAsserts<T>> Visibility_is<T>
   (
      Visibility expected,
      string     characterisationHeader
   )
