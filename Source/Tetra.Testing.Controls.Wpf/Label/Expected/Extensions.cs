...
public static class Expected_label_Extensions
{
   ...
   (
      this Expected_label.ExceptCarrier<T> except
   )
      => except
   ...
   public static Expected_label Visibility_is_collapsed
   (
      this Expected_label.DefineVisibility factory
   )
      => factory
        .Visibility_is(Visibility.Collapsed);
   ...
   public static Expected_label Visibility_is_hidden
   (
      this Expected_label.DefineVisibility factory
   )
      => factory
   ...
   public static Expected_label Visibility_is_visible
   (
      this Expected_label.DefineVisibility factory
   )
      => factory
